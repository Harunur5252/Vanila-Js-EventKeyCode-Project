...
# EventKeyCode project 
Simple event key code project where a user can see any key unicode value and also see which keyboard key is pressed.   

## Project Specifications

+ Create a simple UI(user interface).
+ Initial state a user can press keyboard key to see the unicode of that key and also see which keyboard key is pressed.   



## Project Picture

![Digit Guessing Game!](/src/images/eventkeycode1.PNG "Digit Guessing Game")

![Digit Guessing Game!](/src/images/eventkeycode2.PNG "Digit Guessing Game")
